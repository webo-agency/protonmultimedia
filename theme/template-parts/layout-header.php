...
>
	<header id="masthead" class="container site-header py-4">
		<div class="desktop-wide:px-smaller-container flex justify-between items-center">
			...
			<main-navigation>
				<nav id="site-navigation" class="main-navigation overflow-scroll overscroll-contain desktop:overscroll-hidden fixed left-0 top-0 w-full h-screen transition-all duration-500 invisible opacity-0 desktop:opacity-100 desktop:visible flex flex-col desktop:flex-row desktop:flex items-center flex-auto z-20 desktop:relative desktop:w-auto desktop:h-auto bg-dark-blue desktop:bg-transparent">
					<?php
						wp_nav_menu(
							array(
