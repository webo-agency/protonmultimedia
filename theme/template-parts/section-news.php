                        ...
                        <div class="h-full w-full relative">
                            <div class="flex flex-col justify-end group-hover:justify-between z-10 absolute h-full w-full">
                                <div>
                                    ...
                                    <h3 class="text-base tablet:text-md desktop-wide:text-lg leading-line-height-normal tablet:leading-line-height-md desktop-wide:leading-line-height-lg mb-4 full-hd:mb-6 font-semibold"><?php echo esc_html( $title ); ?></h3>
                                </div>
