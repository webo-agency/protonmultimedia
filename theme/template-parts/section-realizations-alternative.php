                        ...
                        <?php while ( $loop->have_posts() ) : $loop->the_post(); $_post = get_post(); ?>
                            <li class="w-full swiper-slide flex flex-row flex-wrap tablet:block float-left">
                                <div class="w-full desktop:w-1/2 object-bottom object-cover desktop:float-left desktop:pr-24 desktop:pb-24">
                                    <div class="overflow-hidden relative min-h-430px max-h-430px desktop:min-h-700px desktop:max-h-700px">
                                                        ...
                                                        <?php foreach( $images as $image_id ): ?>
                                                            <li class="w-full h-auto swiper-slide">
                                                                <?php echo wp_get_attachment_image( 
                                                                    ...
                                                                    "", 
                                                                    array(
                                                                        'class' => 'w-auto h-auto min-w-full min-h-430px desktop:min-h-full desktop:min-h-700px max-w-none'
                                                                    ) 
                                                                ); ?>
                                                            </li>
                                                        <?php endforeach; ?>
                                ...
                                <div class="w-full desktop:w-1/2 relative flex-auto flex flex-col flex-end p-4 desktop:pl-24 desktop:pr-32 desktop:pt-12 overflow-hidden z-30 justify-start desktop:float-left desktop:-ml-24">
